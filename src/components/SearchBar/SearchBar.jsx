...
const SearchBar = (props) => {
  ...
  const search = async () => {
    // Make sure all fields have values, or handle empty fields as needed
    const criteria = { ...jobCriteria };

    if (!criteria.title) criteria.title = ""; // or handle accordingly
    if (!criteria.location) criteria.location = "";
    if (!criteria.experience) criteria.experience = "";
